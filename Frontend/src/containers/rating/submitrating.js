...
class SubmitRating extends Component {
	onSubmit(formValue){
		...
		this.props.postRating(id,formValue,()=>{
	...
	render(){
		...
		return(
			<div className="container">
				<div className="text-center"><h1>SUBMIT THE RATING FOR BUYED PRODUCT</h1></div>
...
SubmitRating = withRouter(SubmitRating);

export default connect(null, {postRating})(reduxForm({
	form:'PostForm',
	fields:['value'],
})(SubmitRating));